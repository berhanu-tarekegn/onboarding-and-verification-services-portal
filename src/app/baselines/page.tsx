...
export default async function GlobalBaselinesListPage() {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500">
            Platform-defined master schemas. Tenants build their extensions upon these.
          </p>
        </div>
        <Link
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {baselines.length === 0 && (
          <div className="col-span-full border border-zinc-200 bg-white rounded-lg p-16 text-center">
            ...
            <p className="text-sm font-semibold text-zinc-900">No baselines configured</p>
            <p className="mt-1 text-sm text-zinc-500">Get started by creating a new platform baseline.</p>
          </div>
        )}
      </div>
    </div>
